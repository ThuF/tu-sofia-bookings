...
public class RoomValidator implements IRoomValidator {
	...
	private static final String VALIDATION_MESSAGE_THE_DEFAULT_PRICE_PER_NIGHT_PROPERTY_CAN_T_BE_NULL = "The [defaultPricePerNight] property can't be null";
	...
	public boolean isValid(Room room) {
		...
		} else if (room.getDefaultPricePerNight() == null) {
			validationMessage = VALIDATION_MESSAGE_THE_DEFAULT_PRICE_PER_NIGHT_PROPERTY_CAN_T_BE_NULL;
		} else {
			isValid = true;
		}
		return isValid;
