...
public class DataSourceModule extends AbstractModule {
	...
	private static final String JPA_PERSIST_MODULE = "tu.sofia.bookings";
	...
	private Properties initializeDataSource(InitialContext context) throws NamingException {
		try {
			...
			// So we can use the DS later on.
			bind(DataSource.class).toInstance(dataSource);

			logger.debug(DEBUG_BIND_1_MESSAGE, dataSource);

			/**
			 * Finds out info about used database.
			 * TODO: Move this logic somewhere else. In separate module
			 * possibly? Read more at:
			 *
			 * <pre>
